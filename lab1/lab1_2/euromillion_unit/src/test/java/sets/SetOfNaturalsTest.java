...
public class SetOfNaturalsTest {
    ...
    public void testEquals() {
        ...
        assertFalse(setA.equals(2));
    }

    @Test
    public void testSize() {
        assertEquals(setD.size(), 6);
        assertEquals(setA.size(), 0);
    }

    @Test
    public void testContains() {
        assertTrue(setD.contains(60));
        assertFalse(setC.contains(7));
    }

    @Test
    public void testSetWithRepeatedElements(){
        int array[] = {1, 2, 2, 3, 4};
        assertThrows(IllegalArgumentException.class, () -> { setA.fromArray( array ); } );
    }
